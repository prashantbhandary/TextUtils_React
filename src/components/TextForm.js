...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className="w-1/2 mt-4">
      ...
      <button className="mx-2 bg-indigo-500 hover:bg-indigo-700 text-white py-2 px-4 rounded transition" onClick={handleLowercase}>
        Convert to Lowercase
      </button>
      <button className="mx-2 bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded transition" onClick={handleClearText}>
        Clear Text
      </button>
    </div>
  </div>
